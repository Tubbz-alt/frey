module.exports = [
  ...
  { chained: true, name: 'prepare', description: 'Installs dependencies like Terraform' },
  {
    chained    : true,
    name       : 'refresh',
    description: 'Refreshes current infra state and saves to terraform.tfstate',
  },
  ...
  { chained: true, name: 'get', description: 'Get infra modules' },
  {
    chained    : true,
    name       : 'plan',
    description: 'Shows infra changes and saves in an executable plan',
  },
  ...
  { chained: true, name: 'install', description: 'Runs Ansible to install software packages' },
  {
    chained    : true,
    name       : 'setup',
    description: 'Runs Ansible to setup configuration templates & restart software packages',
  },
  ...
  { chained: false, name: 'docbuild', description: 'Build docs' },
  {
    chained    : false,
    name       : 'format',
    description: 'Format a Freyfile (overwriting existing, so only do this under source control)',
  },
  {
    chained    : false,
    name       : 'convert',
    description: 'Convert existing tf and yaml files to a Freyfile',
  },
